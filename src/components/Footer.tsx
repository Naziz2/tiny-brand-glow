        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-600 hover:text-tunisia-blue transition-colors duration-200">
              ...
              <a href="#" className="text-gray-600 hover:text-bergandi-red transition-colors duration-200">
          ...
          {/* Shop Links */}
          <div>
            <h4 className="text-sm font-medium text-tunisia-blue uppercase tracking-wider mb-4">Shop</h4>
            <ul className="space-y-2">
              {footerLinks.shop.map((link) => (
                <li key={link}>
                  <a href="#" className="text-sm text-gray-600 hover:text-bergandi-red transition-colors duration-200">
                    {link}
                  </a>
                </li>
              ))}
          ...
          {/* About Links */}
          <div>
            <h4 className="text-sm font-medium text-tunisia-blue uppercase tracking-wider mb-4">About</h4>
            <ul className="space-y-2">
          ...
          {/* Support Links */}
          <div>
            <h4 className="text-sm font-medium text-tunisia-blue uppercase tracking-wider mb-4">Support</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-100 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 sm:mt-0">
              <a href="#" className="text-sm text-gray-600 hover:text-tunisia-blue transition-colors duration-200">
                Privacy Policy
              </a>
              <a href="#" className="text-sm text-gray-600 hover:text-bergandi-red transition-colors duration-200">
                Terms of Service
